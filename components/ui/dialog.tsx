...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "glass fixed inset-x-3 bottom-3 z-50 grid max-h-[88vh] gap-4 overflow-y-auto rounded-[2rem] p-5 shadow-2xl sm:bottom-auto sm:left-1/2 sm:top-1/2 sm:w-[calc(100vw-2rem)] sm:max-w-xl sm:-translate-x-1/2 sm:-translate-y-1/2",
        className
      )}
      {...props}
    >
